...
public class BasicByakuganRenderer extends MobRenderer<BasicByakuganEntity, PlayerModel<BasicByakuganEntity>> {
    ...
    @Override
    public ResourceLocation getEntityTexture(BasicByakuganEntity entity) {
        return TEXTURE;
    }
}