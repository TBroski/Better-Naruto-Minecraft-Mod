...
public class WoodNatureJutsu extends AbstractJutsuScreen {

    private ArrayList<BeNMJutsu> jutsus = new ArrayList<>();

    public WoodNatureJutsu() {
        super(new TranslationTextComponent("gui." + Main.MODID + ".title.woodnaturejutsu"));
        for (BeNMJutsu jutsu : BeNMRegistry.JUTSUS.getValues()) {
            if (jutsu.getType() == BeNMJutsu.Type.WOOD_NATURE) {
