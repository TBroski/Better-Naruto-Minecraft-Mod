...
public class GuiButtonMessageJutsu extends Button {
    ...
    public GuiButtonMessageJutsu(int widthIn, int heightIn, IPressable onPress) {
    ...
    public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
        ...
        if (playercap.returnToggleJutsuMessage()) {
            v = 89;
        } else {
            v = 110;
        }
