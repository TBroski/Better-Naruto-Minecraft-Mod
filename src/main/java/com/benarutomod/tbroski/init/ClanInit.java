...
public class ClanInit {
    ...
    public static final BeNMClan UCHIHA = new BeNMClan("uchiha", 1).setClanDojutsu(DojutsuInit.SHARINGAN).setClanNature(BeNMClan.Nature.FIRE).setClanMessage("Your eyes sting, an Uchiha?");
