...
public class BijuuJutsuInit {
    ...
    public static void registerBijuuJutsu(BeNMRegistry.JutsuRegistry jutsuRegistry, IBeNMPlugin pluginIn) {
        jutsuRegistry.register(new BeNMJutsu(pluginIn, "tailed_beast_bomb", BeNMJutsu.Type.BIJUU_ABILITY, 20, 300F, 448, 0, false, (playerIn, taijutsuModifier0, taijutsuModifier1, playerCapability) -> {
