...
public class JutsuCaller {
    ...
    public static void JutsuCaller(PlayerEntity playerIn, String jutsu)
    {
        if (jutsu != null) {
            if (jutsu.equalsIgnoreCase("jutsu." + Main.MODID + ".clone")) {
                NetworkLoader.INSTANCE.sendToServer(new PacketJutsu(CloneJutsu.BasicCloneJutsuID, 1, 1));
            }
            if (jutsu.equalsIgnoreCase("jutsu." + Main.MODID + ".replacement")) {
                NetworkLoader.INSTANCE.sendToServer(new PacketJutsu(BodyReplacementJutsu.BasicBodyReplacementJutsuID, 1, 1));
            }
            if (jutsu.equalsIgnoreCase("jutsu." + Main.MODID + ".invisibility")) {
            ...
            if (jutsu.equalsIgnoreCase("jutsu." + Main.MODID + ".fistrock")) {
