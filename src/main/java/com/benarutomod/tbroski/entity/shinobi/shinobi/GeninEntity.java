...
public class GeninEntity extends AbstractShinobiEntity {
    private static final DataParameter<Integer> VARIANT = EntityDataManager.createKey(GeninEntity.class, DataSerializers.VARINT);
    ...
    public GeninEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
        this.setCustomName(new StringTextComponent("Genin"));
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new RangedAttackGoal(this, this.getSpeed(), 60, 10F));
    ...
    public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
        ...
        kunai.shoot(d1, d0 - kunai.getPosY() + (double) MathHelper.sqrt(d1 * d1 + d3 * d3) * 0.2F, d3, 1.75F, 8.0F);
    ...
    protected void registerAttributes() {
        ...
        this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(7.5D);
    }
}
