...
public class JoninEntity extends AbstractShinobiEntity {
    private static final DataParameter<Integer> VARIANT = EntityDataManager.createKey(JoninEntity.class, DataSerializers.VARINT);
    ...
    public JoninEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
        this.setCustomName(new StringTextComponent("Jonin"));
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new RangedAttackGoal(this, this.getSpeed(), 35, 10F));
    ...
    public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
        ...
        kunai.shoot(d1, d0 - kunai.getPosY() + (double) MathHelper.sqrt(d1 * d1 + d3 * d3) * 0.2F, d3, 1.9F, 4F);
