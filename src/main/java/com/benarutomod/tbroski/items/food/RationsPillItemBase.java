...
public class RationsPillItemBase extends Item {


    public RationsPillItemBase() {
        super(new Item.Properties().group(Main.TAB).maxStackSize(16).food((new Food.Builder().hunger(2).saturation(0.1F).setAlwaysEdible()).build()));
    }
